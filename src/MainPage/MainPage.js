                ...
                <div className="search-wrapper">
                    ...
                    <div className="icons-wrapper-bottom">
                        <div className="icons-bottom-left-right">
                            ...
                            <ItemModal itemType="dessert" open={isDessertOpen} onClose={() => setIsDessertOpen(false)} />
                        </div>
                        ...
                        <div className="icons-bottom-left-right">
                            ...
                            <ItemModal itemType="combo" open={isComboOpen} onClose={() => setIsComboOpen(false)} />
                        </div>
                    </div>
                </div>
                    ...
                    <div className="lunch-menu-inner-wrapper">
                        <form className="search-form-wrapper">
                            <div className="search-bar-wrapper">
                                <input className="search-bar" placeholder="Peanut Butter Jelly Sandwich" />
                            </div>
                        ...
                        <div className="lunch-items-wrapper">
                            <div className="lunch-items-inner-wrapper">
                                <div className="lunch-item"></div>
                                <div className="lunch-item"></div>
                                <div className="lunch-item"></div>
                                <div className="lunch-item"></div>
                                <div className="lunch-item"></div>
